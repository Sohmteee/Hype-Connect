      ...
      <main className="container py-24 md:py-32">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            <HypeSonoveaLogo className="h-20 w-20 mx-auto mb-4 text-primary neon-glow-primary" />
          ...
          <Card className="mb-8">
            ...
            <CardContent className="space-y-4 text-muted-foreground">
              <p>
                HypeSonovea was born from the energy of live events. We saw a gap between the audience wanting to interact and the artists on stage ready to engage. Our mission is to bridge that gap with a seamless, exciting, and real-time platform.
              </p>
              <p>
              ...
              <p>
                Whether you're in the crowd or on the stage, HypeSonovea is here to amplify the experience and make every event more interactive, personal, and memorable.
              </p>
            </CardContent>
          </Card>
